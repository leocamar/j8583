...
public class IsoMessage {
	...
	private boolean isFuckEnconded = false;
	...
	public byte[] writeData() {
		...
		if (binary) {
			if (isFuckEnconded) {
				bout.write(0xf0 | ((0xf000 & type) >> 12));
				bout.write(0xf0 | ((0x0f00 & type) >> 8));
				bout.write(0xf0 | ((0x00f0 & type) >> 4));
				bout.write(0xf0 | ((0x000f & type)));
			} else {
	...
	public boolean isFuckEnconded() {
		return isFuckEnconded;
	}

	public void setFuckEnconded(boolean isFuckEnconded) {
		this.isFuckEnconded = isFuckEnconded;
	}
